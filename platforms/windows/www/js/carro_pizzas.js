...
$(document).ready(function() {
	...
	$('#wrap li').click(function(){
		...
		else
		{
			...
			$('#left_bar .cart-info').append('<div class="shopp" id="each-'+thisID+'"><div class="label">'+itemname+'</div><div class="shopp-price"> $<em>'+itemprice+'</em></div><span class="shopp-quantity">1</span><img src="img/remove.png" class="remove" /><br class="all" /></div>');
